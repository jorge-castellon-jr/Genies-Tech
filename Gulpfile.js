 ...
 */
gulp.task( 'clean:pot', () =>
	del( [ 'languages/thorium-design.pot' ] )
);
...
gulp.task( 'wp-pot', [ 'clean:pot' ], () =>
	gulp.src( paths.php )
		...
		.pipe( sort() )
		.pipe( wpPot( {
			'domain': 'thorium-design',
			'package': 'thorium-design',
		} ) )
		.pipe( gulp.dest( 'languages/thorium-design.pot' ) )
);
...
gulp.task( 'watch', function () {
	...
	browserSync( {
		...
		'proxy': 'https://genies-tech.dev',    // Use https://anthonyskelton.com:3000 to use BrowserSync.
		'watchOptions': {
