 ...
 */
function thd_display_scaffolding_section( $args = array() ) {
	...
	$allowed_tags = thd_scaffolding_allowed_html();
	...
	<div class="scaffolding-document <?php echo esc_attr( $class ); ?>">
		...
		<header class="scaffolding-document-header">
			...
			<button type="button" class="scaffolding-button"><?php esc_html_e( 'Details', 'thorium-design' ); ?></button>
		...
		<div class="scaffolding-document-content">
			...
			<?php if ( $args['description'] ) : ?>
				<p><strong><?php esc_html_e( 'Description', 'thorium-design' ); ?>:</strong></p>
				<p class="scaffolding-document-description"><?php echo esc_html( $args['description'] ); ?></p>
			<?php endif; ?>

			<?php if ( $args['parameters'] ) : ?>
				<p><strong><?php esc_html_e( 'Parameters', 'thorium-design' ); ?>:</strong></p>
			...
			<?php if ( $args['arguments'] ) : ?>
				<p><strong><?php esc_html_e( 'Arguments', 'thorium-design' ); ?>:</strong></p>
			...
			<?php if ( $args['usage'] ) : ?>
				<p><strong><?php esc_html_e( 'Usage', 'thorium-design' ); ?>:</strong></p>
				<pre><?php echo esc_html( $args['usage'] ); ?></pre>
			<?php endif; ?>

			<?php if ( $args['output'] ) : ?>
				<p><strong><?php esc_html_e( 'HTML Output', 'thorium-design' ); ?>:</strong></p>
 ...
 * @author Carrie Forde
 */
function thd_scaffolding_allowed_html() {
 ...
 * @author Carrie Forde
 */
function thd_display_global_scaffolding_section( $args = array() ) {
 ...
 * @author Carrie Forde
 */
function thd_hook_theme_scaffolding() {
...
add_action( 'thd_scaffolding_content', 'thd_hook_theme_scaffolding' );
